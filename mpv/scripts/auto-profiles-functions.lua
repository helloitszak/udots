...
function dedicated_gpu()
    if is_osx then
        ...
        return string.find(r.stdout, "Chipset Model: Radeon") ~= nil or string.find(r.stdout, "Chipset Model: AMD Radeon") ~= nil or string.find(r.stdout, "Chipset Model: NVIDIA GeForce") ~= nil
    -- Untested
    elseif is_linux then
